namespace AI_X_GrayLog.Application.DTOs.Requests;

/// <summary>
/// Graylog Webhook 告警請求 DTO
/// </summary>
public class GraylogWebhookRequest
{
    /// <summary>
    /// 事件定義 ID
    /// </summary>
    ...
    /// 事件資料
    /// </summary>
    public GraylogEventDto? Event { get; set; }
